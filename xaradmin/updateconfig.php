...
function smilies_admin_updateconfig()
{
    ...
    if (!xarVarFetch('popupsmilies',    'checkbox',      $popupsmilies,    false,  XARVAR_NOT_REQUIRED)) return;
